...
// Method to process data from Flipkart
function processFlipkartData(res, flipkartData) {
    ...
    $(productSectionClass).each(function (index, element) {
        const name = $(this).find("a.s1Q9rs").text();

        const author = $(this).find("div._3Djpdu").text();

        const price = $(this).find("a._8VNy32>div._25b18c>div._3I9_wc").text();
        const finalPrice = $(this)
            .find("a._8VNy32>div._25b18c>div._30jeq3")
            .text();
        const img = $(this)
            .find("a._2rpwqI>div>div>div.CXW8mj>img")
            .attr("src");

        let buyingUrl = $(this).find("a._2rpwqI").attr("href");
        buyingUrl = "https://www.flipkart.com" + buyingUrl;
        let ratingToken = "div.gUuXy- > span > div._3LWZlK";
